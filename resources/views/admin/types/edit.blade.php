    ...
    <div class="admin-wrapper">
        <div class="card-box card-box-small">
            ...
            <div class="card-header-form">
                ...
                <h1 class="form-header-title">Modifier un type de véhicules</h1>
            </div>

            <form action="{{ route('admin.types.update', $type->id) }}" method="POST" class="standard-form">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="nom" class="form-label">Nom</label>
                    <input type="text" id="nom" name="nom" value="{{ old('nom', $type->nom) }}" required autofocus class="form-input">
                    @error('nom')
